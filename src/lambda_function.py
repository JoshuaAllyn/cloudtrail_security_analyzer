...
from report import generate_report, build_alert_message
from sns_alerts import send_sns_alert
...
def lambda_handler(event, context):
    ...
    message = build_alert_message(num_of_events, failed_logins, unusual_regions, sensitive_api, priv_escalation)
